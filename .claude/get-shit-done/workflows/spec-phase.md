...
```bash
INIT=$(node "/Users/mali/Documents/Projects/MealTracker/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/mali/Documents/Projects/MealTracker/.claude/get-shit-done/templates/spec.md.
