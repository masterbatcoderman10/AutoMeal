...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@.agents/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `.agents/get-shit-done/workflows/transition.md`.
