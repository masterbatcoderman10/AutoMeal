...
<required_reading>
@.agents/get-shit-done/references/ai-frameworks.md
@.agents/get-shit-done/references/ai-evals.md
</required_reading>
...
Copy template:
```bash
cp ".agents/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
