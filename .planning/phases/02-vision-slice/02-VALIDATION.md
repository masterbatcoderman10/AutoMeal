...
| 02-04-01 | 04 | 4 | VISION-01, VISION-03, VISION-04 | T-02-10 / provider drift | smoke script exercises detect, segment, and label through shared runtime code and fails closed on parse or validator errors | script | `.venv/bin/python scripts/vision_smoke.py --mode all --sample sample_images/IMG_4583.HEIC` | ✅ | ✅ green |
| 02-04-02 | 04 | 4 | VISION-01 | T-02-11 / config drift | env template documents all optional vision settings and default behavior | source check | `rtk rg -n \"DETECT_MODEL|SEGMENT_MODEL|SEGMENT_RETRY_MODEL|LABEL_MODEL|VISION_MAX_SEGMENTS\" .env.example` | ✅ | ✅ green |
| 02-04-03 | 04 | 4 | VISION-03, VISION-04 | T-02-12 / unverifiable slice | UAT evidence records grouped sample-image behavior, crop files, and final Telegram output | doc check | `rtk rg -n \"IMG_4583|grouped|crop|non-food\" .planning/phases/02-vision-slice/02-UAT.md` | ✅ | ✅ green |
