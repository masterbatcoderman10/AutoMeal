...
```bash
INIT=$(node "/Users/mali/Documents/Projects/MealTracker/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/mali/Documents/Projects/MealTracker/.opencode/get-shit-done/templates/spec.md.
