...
```bash
INIT=$(node "/Users/mali/Documents/Projects/MealTracker/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/mali/Documents/Projects/MealTracker/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
