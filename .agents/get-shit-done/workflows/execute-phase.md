...
@.agents/get-shit-done/references/context-budget.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @.agents/get-shit-done/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @.agents/get-shit-done/references/planner-antipatterns.md
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Agent(
     ...
     prompt="
       ...
       <execution_context>
       {WORKTREE_ROOT}/.agents/get-shit-done/workflows/execute-plan.md
       {WORKTREE_ROOT}/.agents/get-shit-done/templates/summary.md
       {WORKTREE_ROOT}/.agents/get-shit-done/references/checkpoints.md
       {WORKTREE_ROOT}/.agents/get-shit-done/references/tdd.md
       {WORKTREE_ROOT}/.agents/get-shit-done/references/worktree-path-safety.md
       ${CONTEXT_WINDOW < 200000 ? '' : '{WORKTREE_ROOT}/.agents/get-shit-done/references/executor-examples.md'}
       </execution_context>
       ...
       ` : ''}
       - {WORKTREE_ROOT}/GEMINI.md (Project instructions, if exists — follow project-specific guidelines and coding conventions)
       - {WORKTREE_ROOT}/.agents/skills/ (Project skills, if present — list skills, read SKILL.md for each, follow relevant rules during implementation)
       </files_to_read>
