...
- **Global scope**: `/Users/mali/Documents/Projects/MealTracker/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/mali/Documents/Projects/MealTracker/.claude/notes/`)
...
2. Glob `/Users/mali/Documents/Projects/MealTracker/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/mali/Documents/Projects/MealTracker/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/mali/Documents/Projects/MealTracker/.claude/notes/` — works in any directory
