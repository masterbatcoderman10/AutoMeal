...
```
Agent(
  prompt="Read /Users/mali/Documents/Projects/MealTracker/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mali/Documents/Projects/MealTracker/.opencode/get-shit-done/templates/VALIDATION.md`
