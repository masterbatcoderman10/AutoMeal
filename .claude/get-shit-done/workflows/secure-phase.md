...
```
Agent(
  prompt="Read /Users/mali/Documents/Projects/MealTracker/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/mali/Documents/Projects/MealTracker/.claude/get-shit-done/templates/SECURITY.md`
