...
1. **Shipping evidence passed?**
   ...
   Block conditions:
   - No passed VERIFICATION.md and no complete zero-issue UAT.md: block with `PHASE_VERIFICATION_INCOMPLETE`; complete or formally re-run verification before shipping.
